...
- **Do NOT** modify `CHANGELOG.md` files inside packages — these are auto-generated by changesets. Create a changeset instead.
- **DO** update changelog files under `docs/src/` — these are manually maintained for the documentation site.
