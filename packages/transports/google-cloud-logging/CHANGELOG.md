...
- [#423](https://github.com/loglayer/loglayer/pull/423) [`dd339b3`](https://github.com/loglayer/loglayer/commit/dd339b3745ad14d703bd8b7f3da8220bd9db3f0f) Thanks [@theogravity](https://github.com/theogravity)! - Add an `onError` config option and prevent unhandled rejections from `write()`.
